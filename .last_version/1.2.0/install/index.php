...
class wappi_whatsapptelegram extends CModule
{
  ...
  public function InstallFiles()
  {
    ...
    file_put_contents(
      $file = $_SERVER['DOCUMENT_ROOT'] . '/bitrix/admin/wappipro_template_list_edit.php',
      '<? require($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/wappi.whatsapptelegram/admin/template_list_edit.php");?>'
    );
    file_put_contents(
      $file = $_SERVER['DOCUMENT_ROOT'] . '/bitrix/admin/wappipro_template_list.php',
      '<? require($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/wappi.whatsapptelegram/admin/template_list.php");?>'
    );
    file_put_contents(
      $file = $_SERVER['DOCUMENT_ROOT'] . '/bitrix/admin/wappipro_cascade_sending.php',
